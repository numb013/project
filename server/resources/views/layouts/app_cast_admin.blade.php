        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background: #9a1414">
                <div class="navbar-header">
                    <a class="navbar-brand" href="/cast_admin">キャスト管理</a>
                </div>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    <li class="dropdown navbar-inverse">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            <li>
                                <a href="{{ route('cast_admin.logout') }}"
                                    onclick="event.preventDefault();
                                             document.getElementById('logout-form').submit();">
                                    Logout
                                </a>

                                <form id="logout-form" action="{{ route('cast_admin.logout') }}" method="POST" style="display: none;">
                                    {{ csrf_field() }}
                                </form>
                            </li>
                            <li class="divider"></li>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="/cast_admin/request_list/list">Flot Charts</a>
                                    </li>
                                    <li>
                                        <a href="/cast_admin/request_list/list">Morris.js Charts</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
